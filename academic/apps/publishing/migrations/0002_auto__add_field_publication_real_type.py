...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):        
        # Adding field 'Publication.real_type'
        db.add_column('publishing_publication', 'real_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Publication.real_type'
        db.delete_column('publishing_publication', 'real_type_id')
