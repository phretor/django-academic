...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Publication.citation_key'
        db.delete_column('publishing_publication', 'citation_key')

        # Adding field 'Publication.slug'
        db.add_column('publishing_publication', 'slug', self.gf('django.db.models.fields.SlugField')(default='concept-drift-2009', max_length=512, db_index=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Publication.citation_key'
        db.add_column('publishing_publication', 'citation_key', self.gf('django.db.models.fields.SlugField')(default='concept-drift-2009', max_length=512, db_index=True), keep_default=False)

        # Deleting field 'Publication.slug'
        db.delete_column('publishing_publication', 'slug')
    ...
    models = {
        ...
        'publishing.publication': {
            'Meta': {'ordering': "['-year']", 'unique_together': "(('nickname', 'year'),)", 'object_name': 'Publication'},
