...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('publishing_publication', (
            ...
            ('citation_key', self.gf('django.db.models.fields.SlugField')(max_length=512, db_index=True)),
        ))
        db.send_create_signal('publishing', ['Publication'])

        # Adding M2M table for field authors on 'Publication'
        db.create_table('publishing_publication_authors', (
        ...
        db.create_unique('publishing_publication_authors', ['publication_id', 'person_id'])
        ...
        # Adding M2M table for field editors on 'Book'
        db.create_table('publishing_book_editors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('book', models.ForeignKey(orm['publishing.book'], null=False)),
            ('person', models.ForeignKey(orm['people.person'], null=False))
        ))
        db.create_unique('publishing_book_editors', ['book_id', 'person_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('publishing_publication_authors')

        # Deleting model 'Book'
        db.delete_table('publishing_book')

        # Removing M2M table for field editors on 'Book'
        db.delete_table('publishing_book_editors')
