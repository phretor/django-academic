...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Publication.nickname'
        db.alter_column('publishing_publication', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Publication.nickname'
        db.alter_column('publishing_publication', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=16))
    ...
    models = {
        ...
        'publishing.coadvisorship': {
            'Meta': {'object_name': 'Coadvisorship'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['people.Person']"}),
            'publication': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['publishing.Thesis']"})
