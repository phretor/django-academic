...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Publication.authors_list'
        db.add_column('publishing_publication', 'authors_list', self.gf('django.db.models.fields.TextField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Publication.author_list'
        db.add_column('publishing_publication', 'author_list', self.gf('django.db.models.fields.TextField')(blank=True, null=True, db_index=True), keep_default=False)

        # Deleting field 'Publication.authors_list'
        db.delete_column('publishing_publication', 'authors_list')
    ...
    models = {
        ...
        'publishing.publication': {
            ...
            'authors_list': ('django.db.models.fields.TextField', [], {'db_index': 'True', 'null': 'True', 'blank': 'True'}),
