...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('publishing_journalarticle', 'nickname', self.gf('django.db.models.fields.SlugField')(default='foo', max_length=32, db_index=True), keep_default=False)

        # Adding field 'ConferenceArticle.nickname'
        db.add_column('publishing_conferencearticle', 'nickname', self.gf('django.db.models.fields.SlugField')(default='foo', max_length=32, db_index=True), keep_default=False)
