...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ConferenceEdition.edition_number'
        db.add_column('publishing_conferenceedition', 'edition_number', self.gf('django.db.models.fields.PositiveSmallIntegerField')(db_index=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ConferenceEdition.edition_number'
        db.delete_column('publishing_conferenceedition', 'edition_number')
